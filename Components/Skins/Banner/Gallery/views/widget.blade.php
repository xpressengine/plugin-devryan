<!-- 갤러리 배너 위젯 -->
@php
    XeFrontend::css(asset('plugins/entrada_theme/src/Components/Skins/Banner/Gallery/assets/css/photoswipe.css'))->load();
    XeFrontend::css(asset('plugins/entrada_theme/src/Components/Skins/Banner/Gallery/assets/css/photoswipe-default-skin.css'))->load();
    XeFrontend::js(asset('plugins/entrada_theme/src/Components/Skins/Banner/Gallery/assets/js/photoswipe.js'))->appendTo('body')->load();
    XeFrontend::js(asset('plugins/entrada_theme/src/Components/Skins/Banner/Gallery/assets/js/photoswipe-ui-default.js'))->appendTo('body')->load();
@endphp
<div class="xe-row">
